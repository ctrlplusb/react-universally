...
// Web path to the appcache manifest file.  This is generated by the
// "offline-plugin" module, configured in our webpack configs.  It provides us
// with offline support.
const appCacheManifest = `${projConfig.bundles.client.webPath}${projConfig.appCache.subDirectory}${projConfig.appCache.manifestFileName}`;
...
function generateHTML(args: Args) {
  ...
  return `<!DOCTYPE html>
    <html manifest='${appCacheManifest}' ${helmet ? helmet.htmlAttributes.toString() : ''}>
      <head>
