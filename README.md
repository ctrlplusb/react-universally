...
The v10 release is [ready](https://github.com/ctrlplusb/react-universally/issues/221)!  It's going through some final review but I would recommend you use the [`next`](https://github.com/ctrlplusb/react-universally/tree/next) branch until this message dissappears.
