...
import { getStringEnvVar, getIntEnvVar } from './utils/envVars';
import type { BuildOptions } from '../tools/types';

// This protects us from accidentally including this configuration in our
// client bundle. That would be a big NO NO to do. :)
if (process.env.IS_CLIENT) {
  throw new Error('You are including the full application configuration in the client bundle!');
}

// These are the configuration paths that are allowed to be provided to our
// client bundle.  If you are consuming configuration values within your
// "src/client" or "src/shared" modules then you will likely need to add the
// respective configuration paths below in order to ensure the values get
// exposed to the client bundle.
//
// These are essentially "rules" stating which configuration items should
// be included.  It MUST match the structure of the actual full config.
//
// You can traverse objects and select specific properties.
//
// Simply attach a truthy value to each path prop to ensure that it gets
// included.
export const allowedForClient = {
